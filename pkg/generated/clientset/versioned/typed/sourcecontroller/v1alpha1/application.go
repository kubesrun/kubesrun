...
import (
	...
	scheme "kubesrun.top/source-controller/pkg/generated/clientset/versioned/scheme"
)
...
func newApplications(c *SourceV1alpha1Client, namespace string) *applications {
	return &applications{
		client: c.RESTClient(),
		ns:     namespace,
	}
