/*
Copyright The Kubesrun Authors.
...
import (
	...
	sourcecontrollerv1alpha1 "kubesrun.top/source-controller/pkg/apis/sourcecontroller/v1alpha1"
	versioned "kubesrun.top/source-controller/pkg/generated/clientset/versioned"
	internalinterfaces "kubesrun.top/source-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "kubesrun.top/source-controller/pkg/generated/listers/sourcecontroller/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SourceV1alpha1().Applications(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SourceV1alpha1().Applications(namespace).Watch(context.TODO(), options)
			},
		},
		&sourcecontrollerv1alpha1.Application{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *applicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sourcecontrollerv1alpha1.Application{}, f.defaultInformer)
}
